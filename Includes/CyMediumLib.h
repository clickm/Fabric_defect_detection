// *****************************************************************************
//
// $Id: CyMediumLib.h,v 1.10 2007/07/04 21:27:06 igors Exp $
//
// cy1h24b1
//
// *****************************************************************************
...
// Define import/export symbols for Windows
    ...
    //
        ...
        #define CY_MEDIUM_LIB_C_API(aType) CY_MEDIUM_LIB_EXTERN_C __declspec(dllexport) aType CY_CALLING_CONV
    ...
    //
        ...
        #define CY_MEDIUM_LIB_C_API(aType) CY_MEDIUM_LIB_EXTERN_C __declspec(dllimport) aType CY_CALLING_CONV
    ...
    #define CY_MEDIUM_LIB_C_API(aType) aType
