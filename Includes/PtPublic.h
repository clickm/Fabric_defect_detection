...
// *****************************************************************************
//
// File Name....: PtPublic.h
//
// *****************************************************************************

#pragma once

#ifndef _PT_PUBLIC_H_
#define _PT_PUBLIC_H_

#ifdef PT_PUBLIC_EXPORTS

    // Define the export symbol
	#ifndef PT_LIB_STATIC
		#define PT_PUBLIC_API __declspec( dllexport )
	#else
		#define PT_PUBLIC_API
	#endif // PT_LIB_STATIC

#else // PT_PUBLIC_EXPORTS

    // Define the import symbol
	#ifndef PT_LIB_STATIC
		#define PT_PUBLIC_API __declspec( dllimport )
	#else
		#define PT_PUBLIC_API
	#endif // PT_LIB_STATIC
    ...
    #pragma comment( lib, "PtPublic" PT_SUFFIX_64 PT_SUFFIX_HYPHEN PT_SUFFIX_STATIC PT_SUFFIX_DEBUG ".lib" )
