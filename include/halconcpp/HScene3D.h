 ...
 *****************************************************************************/
  ...
  // Set parameters of a text label in a 3D scene.
  void SetScene3dLabelParam(Hlong LabelIndex, const HString& GenParamName, const HString& GenParamValue) const;

  // Set parameters of a text label in a 3D scene.
  void SetScene3dLabelParam(Hlong LabelIndex, const char* GenParamName, const char* GenParamValue) const;
